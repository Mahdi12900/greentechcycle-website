...
export default function Header() {
  ...
  const megaMenus: Record<string, { href: string; label: string }[]> = {
    ...
    solutions: [
      ...
      { href: "/processus-itad", label: t("megaMenu.solutions.items.process") },
      { href: "/securite", label: t("megaMenu.solutions.items.security") },
      { href: "/impact", label: t("megaMenu.solutions.items.impact") },
    ],
    resources: [
