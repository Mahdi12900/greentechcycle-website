...
export const metadata: Metadata = {
  ...
  description:
    "Solutions ITAD pour le secteur public : conformité réglementaire, transparence des processus, marchés publics, gestion des données sensibles et reporting ESG.",
